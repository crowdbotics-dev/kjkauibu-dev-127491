...
class promtdetoxViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_PROMTDETOX_PASSWORD
    USERNAME = settings.CONNECTOR_PROMTDETOX_USERNAME
    BASE_URL = "https://api.kichoku.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_PROMTDETOX"
